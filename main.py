...
# ============================================================
# AI PROMPT + COST LOGIC
# ============================================================

def build_ai_prompt() -> str:
    return (
        "You are a professional auto-body damage estimator based in Ontario, Canada.\n"
        ...
        "4) Estimate a realistic Ontario repair cost range in CAD.\n"
        "\n"
        "Important:\n"
        "- Use data consistent with what reputable collision centres in Ontario\n"
        "  would charge, not the cheapest possible price.\n"
...
async def run_ai_estimate_from_bytes_list(
    ...
    """
    Calls OpenAI with MULTIMODAL chat.completions (gpt-4o-mini)
    and expects JSON back.
    """
    if not images:
        raise ValueError("No images to analyze.")

    # Build image parts as data URLs for gpt-4o-mini
    image_parts = []
    for b in images[:3]:
            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        "Please analyse the damage following the instructions and "
...
async def sms_webhook(request: Request):
    ...
    price_line = f"Estimated Range: ${est_min:,.0f} – ${est_max:,.0f}"
      ...
      <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,"SF Pro Text","Inter",sans-serif;}
        ...
        .sq-upload-area{
          ...
          text-align:center;
          cursor:pointer;
          transition:border .15s,background .15s,transform .1s,box-shadow .15s;
        }
        ...
        function renderStepUpload(){
          stepContainer.innerHTML = `
            <section>
              ...
              <div class="sq-stack">
                <div class="sq-upload-card">
                  <label class="sq-upload-area" id="uploadZone">
                    <input id="fileInput" type="file" accept="image/*" multiple style="display:none" />
                    <div class="sq-upload-icon"><span>↑</span></div>
                    <div class="sq-upload-title">Drag photos here or tap to select</div>
                    <div class="sq-upload-sub">Up to 3 photos · Front, angled & close-up work best.</div>
                  </label>
                </div>
            ...
            <section>
              ...
              <div class="sq-summary-box">
                ...
                <div class="sq-summary-badges">
                  <span class="sq-badge">Local repair rates</span>
