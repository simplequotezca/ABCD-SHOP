...
# ============================================================
# Email notification config (SendGrid)
# ============================================================
...
SHOP_NOTIFICATION_EMAIL = os.getenv(
    "SHOP_NOTIFICATION_EMAIL",
    "shiran.bookings@gmail.com",
)
...
def send_booking_email(shop: ShopConfig, description: str):
    """
    Send a plain-text booking notification email to the shop using SendGrid.
    """
    if not SENDGRID_API_KEY:
        print("SENDGRID_API_KEY not set – skipping booking email.")
        return
    ...
    try:
        ...
        print("Booking email sent via SendGrid – status:", response.status_code)
    except Exception as e:
        print("SendGrid booking email error:", e)
