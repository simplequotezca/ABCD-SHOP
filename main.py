...
<div class="page">
  <div class="card hero">
    ...
    <img src="/static/logo.png" class="logo landing-logo" alt="SimpleQuotez" onerror="this.style.display='none'"/>
...
<div class="page">
  <div class="card hero">
    ...
    <div id="loader" class="analyzer hidden">
      <div class="loader-text">Analyzing vehicle damage…</div>
      <div class="loader-sub">Reviewing uploaded photos</div>
      <div class="progress">
