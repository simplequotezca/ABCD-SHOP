...
<html><body class="page">
  <div class="card">
    ...
    <a class="backlink" href="/estimate/result?id={estimate_id}">← Back</a>
  </div>
</body></html>""",
            status_code=500,
        )
...
<body class="page">
  <div class="card">
    ...
    <div style="margin-top:14px; line-height:1.45;">
      We’ve sent your appointment request to the shop’s calendar.
      They’ll confirm details with you if needed.
    </div>
